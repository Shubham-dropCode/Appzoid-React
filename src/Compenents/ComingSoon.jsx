...
export default function ComingSoon({ title = "", subTitle = "", ComingSoonFeature = [] }) {
    return (
                    ...
                    <div className="row justify-content-center mb-3">
                        <div className="col-12">
                            <div className="section-title mb-4 pb-2 text-center">
                                <h1 className="display-5 pb-2"><span className="underline">{title}</span></h1>
